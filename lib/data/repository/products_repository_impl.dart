...
import 'package:online_shop_udemy/data/repository/products_repository.dart';

class ProductRepositoryImpl extends ChangeNotifier
  ...
  List<Product> _products = [
    ...
    Product(
        ...
        price: 50.99,
        imgUrl: 'https://m.media-amazon.com/images/I/71XXJC7V8tL._FMwebp__.jpg',
        brand: 'Apple',
        productCategoryName: 'Phones',
        quantity: 2654,
        isPopular: false),
    ...
    Product(
        ...
        price: 88.88,
        imgUrl:
            'https://www.google.com.vn/url?sa=i&url=https%3A%2F%2Fwww.highsnobiety.com%2Ftag%2Fadidas%2F&psig=AOvVaw1cvO2XVJJVvt3Uu6vLd9t4&ust=1629799715991000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCMj7257zxvICFQAAAAAdAAAAABAE',
        brand: 'Adidas',
        productCategoryName: 'Clothes',
        quantity: 8941,
        isPopular: true),
    ...
    Product(
        ...
        price: 180.99,
        imgUrl:
            'https://www.google.com.vn/imgres?imgurl=https%3A%2F%2Fhips.hearstapps.com%2Fhmg-prod.s3.amazonaws.com%2Fimages%2F2021-lamborghini-huracan-evo-mmp-1-1600293029.jpg%3Fcrop%3D0.889xw%3A1.00xh%3B0.0561xw%2C0%26resize%3D640%3A*&imgrefurl=https%3A%2F%2Fwww.caranddriver.com%2Flamborghini%2Fhuracan&tbnid=QuTlRAttz6ViaM&vet=12ahUKEwiXhMny88byAhVE5JQKHYPlCxUQMygHegUIARDcAQ..i&docid=yn8x9biqxmGEQM&w=640&h=480&q=lamborghini&hl=en&authuser=0&ved=2ahUKEwiXhMny88byAhVE5JQKHYPlCxUQMygHegUIARDcAQ',
        brand: 'Lamborghini',
    ...
    Product(
        ...
        price: 180.99,
        imgUrl:
            "https://www.google.com.vn/imgres?imgurl=https%3A%2F%2Fwww.lamborghini.com%2Fsites%2Fit-en%2Ffiles%2FDAM%2Flamborghini%2Ffacelift_2019%2Fmodel_gw%2Fimages-s%2F2021%2F07_07%2Fgate_family_og.jpg&imgrefurl=https%3A%2F%2Fwww.lamborghini.com%2Fen-en%2Fmodels&tbnid=cfK6epn1dzskRM&vet=12ahUKEwiXhMny88byAhVE5JQKHYPlCxUQMygWegUIARD6AQ..i&docid=EID4z4HJNRxdmM&w=1920&h=1080&q=lamborghini&hl=en&authuser=0&ved=2ahUKEwiXhMny88byAhVE5JQKHYPlCxUQMygWegUIARD6AQ",
        brand: 'Lamborghini',
        productCategoryName: 'Cars',
        quantity: 1,
        isPopular: true),
  ...
  List<Product>? getProductsByCategory(String categoryName) {
    final List<Product> listFound = _products
        .where((element) =>
  ...
  Iterable<Product>? getProductsByBrand(String brand) {
    final Iterable<Product> listFound = _products
        .where((element) => element.brand.toLowerCase() == brand.toLowerCase());
    return listFound;
  }
  ...
  List<Product> filterProduct(String content) {
    final List<Product> listFound = _products
        .where((element) =>
            element.productCategoryName.toLowerCase().contains(content))
        .toList();
    return listFound;
  }
}
